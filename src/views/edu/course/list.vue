<template>
  <div class="app-container">
    ...
    <el-form :inline="true" class="demo-form-inline">
      ...
      <el-form-item>
        <el-input v-model="courseQuery.viewCount" placeholder="浏览量大于"/>
      </el-form-item>
    ...
    <el-table :data="list" border fit highlight-current-row>
      ...
      <el-table-column prop="lessonNum" width="80" label="课时数"/>
      ...
      <el-table-column label="操作" width="250" align="center">
        <template slot-scope="scope">
          ...
          <router-link :to="'/course/info/' + scope.row.id">
            <el-button type="primary" size="mini" icon="el-icon-edit" round plain>编辑课程基本信息</el-button>
          </router-link>
          <router-link :to="'/course/chapter/' + scope.row.id">
            <el-button type="primary" size="mini" icon="el-icon-edit" round plain>编辑课程大纲息</el-button>
          </router-link>
          <el-button type="danger" size="mini" icon="el-icon-delete"
                     @click="removeDataById(scope.row.id)" round plain>删除课程信息
          </el-button>
        </template>
      </el-table-column>
    </el-table>
